...
<body>
    ...
    <nav class="navbar">
                    <ul>
                        ...
                        <li><a style="text-decoration:none" href="service.php" class="nvs">Service</a></li>
        ...
        <a style="text-decoration:none";  class="btn" href="pg2.php"><font color="white"><b>START</b></a>
    </div>
</body>
<html>