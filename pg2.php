<html>
    <head>
        ...
        <style>
        body{
            background-image: url("img/ire.JPG");
...
<body>
    ...
    <button type="btn" class="btn2" onclick = "window.location.href='parent-login.php';"> Get a Tutor</button>
    <button type="btn" class="btn3" onclick = "window.location.href='tutor-login.php';"> Become a Tutor</button>
    </div>
    <nav class="navbar">
                    <ul>
