...
<div class="wrapper-main"></div>
    <nav class="navbar">
        ...
        <form class="login-form" action="create-acct.php" method="post">
            ...
            <div class="container">
             ...
             <!--Username Input-->
                ...
                <h3><font size="6"><font color="white"><b>Create Account </b></a></h3>
                ...
                <font color="white">Already Have Account? <a href="parent-login.php"><font size="3"><b><font color="yellow">SIGN IN</b></a>
                </div>
                </p>
