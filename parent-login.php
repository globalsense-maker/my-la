...
<head>
	...
	<meta charset = "utf-8">
      ...
      <style>
        body{
            background-image: url('img/ht-img6.jpg');
...
<div class="wrapper-main"></div>
    ...
    <nav class="navbar-footer">
            ...
            <div class="container"> 
                <form class="login-container" action="parent-dashboard.php" method="post">           
				<h3 align="center"><font size="5"><font color="#AD0BBD" ><b>Parent Login</b></a></h3>
                ...
                <font color="red">Don't Have An  Account? As Parent <a href="create-acct.php"><font size="3"><b>SIGN up </b></a>
                </div>
                </p>
                </form>
